...
public class SpeedConverter {
    ...
    invalid value.Otherwise, if it is positive, calculate the value of miles per hour, round it and return it.
    ...
    * printConversion(75.114); → should print the following text (into the console - System.out): 75.114 km/h = 47 mi/h
    ...
    public static void main(String[] args) {
        //  Chamando apenas o metodo, o output é a msg no sout sem o valor aredondado
//        toMilesPerHour(1.5);
        //  Ao atribuirmos o valor retornado pelo metodo a uma variavel, o output é o valor arredondado
        long milesPerHours =  toMilesPerHour(25.42);
        System.out.println(milesPerHours);
    ...
    public static long toMilesPerHour(double kilometersPerHours) {
        ...
        //  Tive duvida se deveria inserir o Math.round aqui na variavel ou no return
        double milesPerHour = kilometersPerHours / 1.609;
//        System.out.println(kilometersPerHours + "km/h = " + milesPerHour + "m/h");
    ...
    public static void printConversion(double kilometersPerHours) {
        ...
        //  A variavel tem de ser do tipo long. Se for do tipo double o resultado vai aparecer com uma casa decimal
