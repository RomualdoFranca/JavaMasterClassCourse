...
*/
    ...
    public static boolean isPerfectNumber(int num) {
        ...
        // variavel onde vai ser atribuido a soma de todos os divisores
        int sumOfDivisor = 0;
//        boolean isPerfectNum = true;
        // a terminacao é i < num para o num nao seja dividido por ele mesmo. O num deve ser excluido
        for (int i = 1; i < num; i++) {
            if (num % i == 0) {
                // soma todos os divisores
                sumOfDivisor += i;
                // valida se a soma dos divisores é igual ao num
                if (sumOfDivisor == num) {
                    return true;
                }
            }
